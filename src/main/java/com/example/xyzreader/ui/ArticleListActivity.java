...
public class ArticleListActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!isNetworkConnected(getApplicationContext())) {
            ...
            Snackbar.make(coordinatorLayout, R.string.connection, Snackbar.LENGTH_LONG)
                    .show();
        }
    ...
    private class Adapter extends RecyclerView.Adapter<ViewHolder> {
        ...
        public void onBindViewHolder(final ViewHolder holder, int position) {
            ...
            holder.subtitleView.setTypeface(Typeface.createFromAsset(getResources().getAssets(), "Roboto-Thin.ttf"));
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view) {
            super(view);
            linearLayout =(LinearLayout) view.findViewById(R.id.list_article_container);
